...
static constexpr bool kEnablePullUp = true;
...
#ifdef HAVE_AVR_PORTB
struct PortB;
template <>
struct Port<PortB> {
  using port = PortB;
  static inline volatile uint8_t& ddr() {
    return Portb::ddrb.raw_bits();
  }
  static inline volatile uint8_t& reg() {
    return Portb::portb.raw_bits();
  }
  static inline volatile const uint8_t& pin() {
    return Portb::pinb.raw_bits();
  }
};
#endif
#ifdef HAVE_AVR_PORTC
struct PortC;
template <>
struct Port<PortC> {
  using port = PortC;
  static inline volatile uint8_t& ddr() {
    return Portc::ddrc.raw_bits();
  }
  static inline volatile uint8_t& reg() {
    return Portc::portc.raw_bits();
  }
  static inline volatile const uint8_t& pin() {
    return Portc::pinc.raw_bits();
  }
};
#endif
#ifdef HAVE_AVR_PORTD
struct PortD;
template <>
struct Port<PortD> {
  using port = PortD;
  static inline volatile uint8_t& ddr() {
    return Portd::ddrd.raw_bits();
  }
  static inline volatile uint8_t& reg() {
    return Portd::portd.raw_bits();
  }
  static inline volatile const uint8_t& pin() {
    return Portd::pind.raw_bits();
  }
};
#endif
#ifdef HAVE_AVR_PORTE
struct PortE;
template <>
struct Port<PortE> {
  using port = PortE;
  static inline volatile uint8_t& ddr() {
    return Porte::ddre.raw_bits();
  }
  static inline volatile uint8_t& reg() {
    return Porte::porte.raw_bits();
  }
  static inline volatile const uint8_t& pin() {
    return Porte::pine.raw_bits();
  }
};
#endif
#ifdef HAVE_AVR_PORTF
struct PortF;
template <>
struct Port<PortF> {
  using port = PortF;
  static inline volatile uint8_t& ddr() {
    return Portf::ddrf.raw_bits();
  }
  static inline volatile uint8_t& reg() {
    return Portf::portf.raw_bits();
  }
  static inline volatile const uint8_t& pin() {
    return Portf::pinf.raw_bits();
  }
};
#endif
